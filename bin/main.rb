...
item_condition_any = 'LH_ItemCondition=0|1000|1500|2000|2500|3000|7000'
...
puts "Please enter the name of the item that you want to search: "
search = CGI::escape(gets.chomp)
puts "Would you like to perform a standard search (0) or a customized search(1)?"
search_type = gets.chomp
doc = Nokogiri::HTML(URI.open("https://www.ebay.com/sch/i.html?_ipg=200&_fcse=10|42|43&LH_ItemCondition=0|1000|1500|2000|2500|3000|7000&LH_FS=0&_nkw=#{search}")) # Encoding::UTF_8.to_s
